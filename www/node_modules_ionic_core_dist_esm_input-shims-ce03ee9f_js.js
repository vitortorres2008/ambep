(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["node_modules_ionic_core_dist_esm_input-shims-ce03ee9f_js"],{
...
const enableHideCaretOnScroll = (componentEl, inputEl, scrollEl) => {
  ...
  (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.a)(scrollEl, 'ionScrollStart', hideCaret);
  (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.a)(scrollEl, 'ionScrollEnd', showCaret);
  inputEl.addEventListener('blur', onBlur);
  return () => {
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.b)(scrollEl, 'ionScrollStart', hideCaret);
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.b)(scrollEl, 'ionScrollEnd', showCaret);
...
const enableInputBlurring = () => {
  ...
  (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.a)(doc, 'ionScrollStart', onScroll);
  doc.addEventListener('focusin', onFocusin, true);
  doc.addEventListener('touchend', onTouchend, false);
  return () => {
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.b)(doc, 'ionScrollStart', onScroll, true);
...
const enableScrollAssist = (componentEl, inputEl, contentEl, footerEl, keyboardHeight) => {
  let coord;
  const touchStart = (ev) => {
    coord = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.p)(ev);
  };
  const touchEnd = (ev) => {
    ...
    const endCoord = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.p)(ev);
...
const jsSetFocus = async (componentEl, inputEl, contentEl, footerEl, keyboardHeight) => {
   ...
   */
  (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.r)(() => componentEl.click());
...
const startInputShims = (config) => {
  ...
  const registerInput = async (componentEl) => {
    await new Promise(resolve => (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__.c)(componentEl, resolve));
