(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["node_modules_ionic_core_dist_esm_ion-slide_2_entry_js"],{
  ...
  connectedCallback() {
    {
      ...
      (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.c)(this.el, () => {
        this.initSwiper();
      });
    }
  }
...
const waitForSlides = (el) => {
  return Promise.all(Array.from(el.querySelectorAll('ion-slide')).map(s => new Promise(resolve => (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.c)(s, resolve))));
};
Slides.style = {
  ios: slidesIosCss,
  md: slidesMdCss
