(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["node_modules_ionic_core_dist_esm_ion-action-sheet_entry_js"],{
...
/* harmony import */ var _index_34cb2743_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-34cb2743.js */ 39461);
...
/* harmony import */ var _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./helpers-1457892a.js */ 71567);
...
const ActionSheet = class {
   ...
   */
  present() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.d)(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
  }
  connectedCallback() {
   ...
   */
  dismiss(data, role) {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the action sheet did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
   ...
   */
  onWillDismiss() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionActionSheetWillDismiss');
  }
  ...
  async callButtonHandler(button) {
    if (button) {
      ...
      const rtn = await (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.s)(button.handler);
      if (rtn === false) {
  ...
  render() {
    ...
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ role: "dialog", "aria-modal": "true", tabindex: "-1" }, htmlAttributes, { style: {
