(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["node_modules_ionic_core_dist_esm_ion-item-option_3_entry_js"],{
...
const ItemOptions = class {
  ...
  render() {
    const mode = (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const isEnd = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.n)(this.side);
...
const ItemSliding = class {
  ...
  async open(side) {
    ...
    side = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.n)(side) ? 'end' : 'start';
  ...
  async updateOptions() {
    ...
    for (let i = 0; i < options.length; i++) {
      ...
      const side = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.n)(option.side) ? 'end' : 'start';
      if (side === 'start') {
