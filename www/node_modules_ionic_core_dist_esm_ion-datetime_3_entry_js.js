(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["node_modules_ionic_core_dist_esm_ion-datetime_3_entry_js"],{
...
const Datetime = class {
  ...
  async open() {
    ...
    const picker = await _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.p.create(pickerOptions);
    this.isExpanded = true;
    picker.onDidDismiss().then(() => {
      this.isExpanded = false;
      this.setFocus();
    });
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.a)(picker, 'ionPickerColChange', async (event) => {
  ...
  validateColumn(columns, name, index, min, max, lowerBounds, upperBounds) {
    ...
    const selectedIndex = column.selectedIndex = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.k)(indexMin, column.selectedIndex, indexMax);
  ...
  render() {
    ...
    const label = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.j)(el);
    ...
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.e)(true, el, this.name, this.value, this.disabled);
...
const iosEnterAnimation = (baseEl) => {
  ...
  const backdropAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_5__.c)();
  const wrapperAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_5__.c)();
  backdropAnimation
...
const Picker = class {
  constructor(hostRef) {
    ...
    this.dispatchCancelHandler = (ev) => {
      ...
      if ((0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.i)(role)) {
   ...
   */
  async present() {
    await (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.d)(this, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined);
    if (this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'pickerLeave', iosLeaveAnimation, iosLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the picker did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionPickerDidDismiss');
  }
  /**
   * Returns a promise that resolves when the picker will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionPickerWillDismiss');
  }
  /**
  ...
  async callButtonHandler(button) {
    if (button) {
      ...
      const rtn = await (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.s)(button.handler, this.getSelected());
      if (rtn === false) {
...
const PickerColumnCmp = class {
  ...
  onEnd(detail) {
    ...
    this.velocity = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.k)(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
  ...
  refresh(forceRefresh) {
    ...
    const selectedIndex = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.k)(min, this.col.selectedIndex || 0, max);
