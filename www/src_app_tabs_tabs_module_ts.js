(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["src_app_tabs_tabs_module_ts"],{
...
/* harmony import */ var _tab2_tab2_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tab2/tab2.page */ 70442);
...
const routes = [
    {
        ...
        children: [
            {
                path: 'tab1',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_ng-lazyload-image_fesm2020_ng-lazyload-image_mjs"), __webpack_require__.e("common"), __webpack_require__.e("src_app_tab1_tab1_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../tab1/tab1.module */ 2168)).then(m => m.Tab1PageModule)
            },
            {
                path: 'tab2',
...
let TabsPage = class TabsPage {
    constructor(controleAcessoProvider) {
        this.controleAcessoProvider = controleAcessoProvider;
    }
    navegacaoGravar(guid) {
        setTimeout(() => {
            if (guid !== null && guid !== undefined) {
                this.controleAcessoProvider.navegacaoGravar(guid).then((result) => {
                    console.log(result);
                });
            }
        }, 100);
