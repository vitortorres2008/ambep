(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["node_modules_ionic_core_dist_esm_ion-popover_entry_js"],{
...
/* harmony import */ var _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./helpers-1457892a.js */ 71567);
/* harmony import */ var _hardware_back_button_4a6b37fb_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./hardware-back-button-4a6b37fb.js */ 23087);
...
const mdEnterAnimation = (baseEl, ev) => {
  ...
  const backdropAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)();
  const wrapperAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)();
  const contentAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)();
  const viewportAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)();
  backdropAnimation
    .addElement(baseEl.querySelector('ion-backdrop'))
    .fromTo('opacity', 0.01, 'var(--backdrop-opacity)')
    .beforeStyles({
...
const Popover = class {
  ...
  async present() {
    ...
    this.usersElement = await (0,_framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.delegate, container, this.component, ['popover-viewport', this.el['s-sc']], data);
    await (0,_index_a7711c1e_js__WEBPACK_IMPORTED_MODULE_5__.e)(this.usersElement);
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.d)(this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, this.event);
  }
  /**
  ...
  async dismiss(data, role) {
    const shouldDismiss = await (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event);
    if (shouldDismiss) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    const mode = (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const { onLifecycle, htmlAttributes } = this;
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ "aria-modal": "true", "no-router": true, tabindex: "-1" }, htmlAttributes, { style: {
