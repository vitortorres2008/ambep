(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["node_modules_ionic_core_dist_esm_ion-back-button_entry_js"],{
...
const BackButton = class {
  constructor(hostRef) {
    ...
    this.onClick = async (ev) => {
      ...
      return (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.o)(this.defaultHref, ev, 'back', this.routerAnimation);
    };
  }
  componentWillLoad() {
  ...
  render() {
    ...
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, class: (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.c)(color, {
        [mode]: true,
        'button': true,
