(self["webpackChunkapp_ambep"] = self["webpackChunkapp_ambep"] || []).push([["node_modules_ionic_core_dist_esm_ion-select_3_entry_js"],{
...
const Select = class {
  ...
  async openPopover(ev) {
    ...
    return _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.c.create(popoverOpts);
  }
  async openActionSheet() {
    const mode = (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const interfaceOptions = this.interfaceOptions;
    const actionSheetOpts = Object.assign(Object.assign({ mode }, interfaceOptions), { buttons: this.createActionSheetButtons(this.childOpts, this.value), cssClass: ['select-action-sheet', interfaceOptions.cssClass] });
    return _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.b.create(actionSheetOpts);
  }
  async openAlert() {
    ...
    return _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.a.create(alertOpts);
  }
  /**
  ...
  getLabel() {
    return (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.j)(this.el);
  }
  hasValue() {
    return this.getText() !== '';
  }
  ...
  render() {
    ...
    const mode = (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const { labelText, labelId } = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.d)(el, inputId);
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_2__.e)(true, el, name, parseValue(value), disabled);
...
const SelectPopover = class {
  ...
  onSelect(ev) {
    ...
    if (option) {
      (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_3__.s)(option.handler);
    }
  }
  render() {
